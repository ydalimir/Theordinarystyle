    ...
    <div>
      <nav>
        <div className="flex justify-center">
          ...
          ">
            <div className="mb-6 sm:mr-16 max-w-48 sm:max-w-none">
              <Link href="/">
                <a aria-label="Home">
                  <img src="https://ydalimir-ecommerce.s3.amazonaws.com/Isotipo_negro_51611bdf4b.png" alt="logo" width="59" height="23" />
                </a>
              </Link>
            </div>
